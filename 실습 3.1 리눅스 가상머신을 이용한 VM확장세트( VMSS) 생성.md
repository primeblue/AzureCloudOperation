...
![image-20200713171638180](C:\Users\young\AppData\Roaming\Typora\typora-user-images\image-20200713171638180.png)
...
2. ![image-20200713172611707](C:\Users\young\AppData\Roaming\Typora\typora-user-images\image-20200713172611707.png)

   Azure Portal 에서 오른쪽 상단에 있는 >_ 아이콘을 클릭하여 Azure Cloud Shell 을 실행합니다. 

3. 

   ![image-20200713172704407](C:\Users\young\AppData\Roaming\Typora\typora-user-images\image-20200713172704407.png)

   스토리지 만들기 버튼을 클릭하여 Azure Cloud Shell 프롬프트로 접속한다.
...
7. 다음 명령어를 사용하여 가상머신의 이름, 리소스그룹, Location과 상태를 확인합니다.
   ...
   ```
   az vm show --resource-group user00RG01 --name user00VM01 --show-deatils --output table 
   ```
...
8. 다음 명령을 수행하여  생성한 리눅스 가상서버에 SSH 접속이 가능하도록 22번 포트를 열어준다.
   ...
   ```
   az vm open-port --port 22 --resource-group uer00RG001 --name user00VM01 --priority 50 
   az vm open-port --port 80 --resource-group user00RG001 --name user00VM01 --priority 60
   ```
...
11. VMSS( VM Scale Set) 에 배포할 "관리이미지" 생성하기
    ...
    ![image-20200713220904221](C:\Users\young\AppData\Roaming\Typora\typora-user-images\image-20200713220904221.png)
...
13. Azure Portal 에 로그인 하여 검색창에 가상머신  입력하여 앞에서 생성한 userXXVM01 를 선택한다.
    ...
    ![image-20200713222800041](C:\Users\young\AppData\Roaming\Typora\typora-user-images\image-20200713222800041.png)
...
14. 이미지 생성이 완료되면 리소스 그룹에서 생성된 이미지를 리소스 리스트에서 확인한다.
     ...
     ![image-20200715031639523](C:\Users\young\AppData\Roaming\Typora\typora-user-images\image-20200715031639523.png)
